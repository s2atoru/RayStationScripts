...
{
    [DataContract]
    public class WallRoiParameters
    {
        [DataMember()]
        public string FormulaType { get; set; } = "WallRoi";
        [DataMember()]
        ...
        {
            return $"Wall ROI: {StructureName} ({StructureType}), Base Structure: {BaseStructureName}, Outer Margin = {OuterMargin:F1} mm, Inner Margin = {InnerMargin:F1} mm";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            WallRoiParameters c = (WallRoiParameters)obj;
        ...
        public static bool operator ==(WallRoiParameters c1, WallRoiParameters c2)
        {
            //Check if null
            if ((object)c1 == null)
            {
