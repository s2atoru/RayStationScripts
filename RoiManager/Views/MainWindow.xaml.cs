...
namespace RoiManager.Views
{
    ...
    public partial class MainWindow : Window
    {
        public MainWindow()
        {
            ...
            rois.Add(new Models.Roi { Name = "zPTV-CTV", IsDerived = true, DependentRois = new List<string> { "PTV", "CTV" }, HasGeometry = true, CanDeleteGeometry = false, CanUnderive = false, CaseName = "C1", ExaminationName = "CT1" });
